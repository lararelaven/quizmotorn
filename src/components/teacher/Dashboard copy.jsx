                    ...
                    {state.savedQuizzes.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            {filteredQuizzes.map((quiz, idx) => (
                                // --- START QUIZ CARD LAYOUT ---
                                <div key={idx} className="bg-white/5 p-5 rounded-2xl border border-white/10 flex flex-col h-full hover:bg-white/10 hover:border-white/20 transition-all backdrop-blur-sm group relative">
                                    ...
                                    <div className="flex-1 mb-3">
                                        <div className="flex flex-col justify-start mb-1">
                                            ...
                                            {/* Info Rad: Kategori + Antal Frågor & Actions */}
                                            <div className="flex items-center justify-between">
                                                {/* Vänster sida: Metadata */}
                                                ...
                                                {/* Höger sida: Actions (Redigera / Ta bort) */}
